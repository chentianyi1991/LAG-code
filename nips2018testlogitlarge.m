...
[Xdata_28] = load('data19/data.txt'); % UCLA Housing dataset
[ydata_28] = load('data19/y.txt'); 
...
for n=1:num_workers
    ...
    elseif n==num_workers
        X{n}=Xdata_28(per_split(n):num_sample,1:num_feature);
        y{n}=ydata_28(per_split(n):num_sample);
    else
